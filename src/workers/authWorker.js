...
// Помощна функция за получаване на auth инстанция
const getAuthInstance = async () => {
  const { useFirebase } = await import('../firebase/FirebaseContext');
...
export const signInNoCredentials = async () => {
  try {
    const { useFirebase } = await import('../firebase/FirebaseContext');
    const firebaseService = useFirebase();
    const userCredential = await firebaseService.signInAnonymously();
